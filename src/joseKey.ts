...
class JSONWebSignatureAndEncryptionAlgorithm {
  ...
  static readonly HS256 = new JSONWebSignatureAndEncryptionAlgorithm('HS256', 'HMAC using SHA-256');
  static readonly HS384 = new JSONWebSignatureAndEncryptionAlgorithm('HS384', 'HMAC using SHA-384');
  static readonly HS512 = new JSONWebSignatureAndEncryptionAlgorithm('HS512', 'HMAC using SHA-512');
  static readonly RS256 = new JSONWebSignatureAndEncryptionAlgorithm('RS256', 'RSASSA-PKCS1-v1_5 using SHA-256');
  static readonly RS384 = new JSONWebSignatureAndEncryptionAlgorithm('RS384', 'RSASSA-PKCS1-v1_5 using SHA-384');
  static readonly RS512 = new JSONWebSignatureAndEncryptionAlgorithm('RS512', 'RSASSA-PKCS1-v1_5 using SHA-512');
  static readonly ES256 = new JSONWebSignatureAndEncryptionAlgorithm('ES256', 'ECDSA using P-256 and SHA-256');
  static readonly ES384 = new JSONWebSignatureAndEncryptionAlgorithm('ES384', 'ECDSA using P-384 and SHA-384');
  static readonly ES512 = new JSONWebSignatureAndEncryptionAlgorithm('ES512', 'ECDSA using P-512 and SHA-512');
  ...
  static readonly NONE = new JSONWebSignatureAndEncryptionAlgorithm('none', 'No digital signature or MAC performed');
  static readonly RSA1_5 = new JSONWebSignatureAndEncryptionAlgorithm('RSA1_5', 'RSAES-PKCS1-v1_5');
  ...
  static readonly A128KW = new JSONWebSignatureAndEncryptionAlgorithm('A128KW', 'AES Key Wrap using 128-bit key');
  static readonly A192KW = new JSONWebSignatureAndEncryptionAlgorithm('A192KW', 'AES Key Wrap using 192-bit key');
  static readonly A256KW = new JSONWebSignatureAndEncryptionAlgorithm('A256KW', 'AES Key Wrap using 256-bit key');
  static readonly DIR = new JSONWebSignatureAndEncryptionAlgorithm('dir', 'Direct use of a shared symmetric key');
  static readonly ECDH_ES = new JSONWebSignatureAndEncryptionAlgorithm('ECDH-ES', 'ECDH-ES using Concat KDF');
  ...
  static readonly A128GCM = new JSONWebSignatureAndEncryptionAlgorithm('A128GCM', 'AES GCM using 128-bit key');
  static readonly A192GCM = new JSONWebSignatureAndEncryptionAlgorithm('A192GCM', 'AES GCM using 192-bit key');
  static readonly A256GCM = new JSONWebSignatureAndEncryptionAlgorithm('A256GCM', 'AES GCM using 256-bit key');
  static readonly EdDSA = new JSONWebSignatureAndEncryptionAlgorithm('EdDSA', 'EdDSA signature algorithms');
  static readonly RS1 = new JSONWebSignatureAndEncryptionAlgorithm('RS1', 'RSASSA-PKCS1-v1_5 with SHA-1');
  ...
  static readonly A128CBC = new JSONWebSignatureAndEncryptionAlgorithm('A128CBC', 'AES CBC using 128 bit key');
  static readonly A192CBC = new JSONWebSignatureAndEncryptionAlgorithm('A192CBC', 'AES CBC using 192 bit key');
  static readonly A256CBC = new JSONWebSignatureAndEncryptionAlgorithm('A256CBC', 'AES CBC using 256 bit key');
  static readonly A128CTR = new JSONWebSignatureAndEncryptionAlgorithm('A128CTR', 'AES CTR using 128 bit key');
  static readonly A192CTR = new JSONWebSignatureAndEncryptionAlgorithm('A192CTR', 'AES CTR using 192 bit key');
  static readonly A256CTR = new JSONWebSignatureAndEncryptionAlgorithm('A256CTR', 'AES CTR using 256 bit key');
  static readonly HS1 = new JSONWebSignatureAndEncryptionAlgorithm('HS1', 'HMAC using SHA-1');
